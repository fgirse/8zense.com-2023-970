...
const IntroWebside = () => {
  //const t = useTranslations('InfoWebside');
  return (
    <>
      <section>
        ...
        <section className="h-33vh mx-auto ">
          <div className='z-10 -mt-60 h-[33vh] w-[77vw] lg:h-[100vh] lg:w-[90vw]'>
          ...
          <section className='container mx-auto mt-16 grid w-full max-w-6xl grid-cols-1 items-center gap-8 px-8 py-12 lg:grid-cols-1'>
            <h1 className='via lg:top lg:leading-0 relative -top-20 bg-slate-600 bg-gradient-to-b from-slate-900 to-slate-500 bg-clip-text px-1 text-[2.33rem] font-black uppercase leading-10 text-transparent md:text-center md:text-[3.750rem]  md:leading-[4rem] lg:text-8xl lg:tracking-wider'>
              {('Intro_Text00')}
            </h1>
            ...
            <p className='my-4 -mt-12 text-base text-slate-700 md:my-6 md:text-lg'>
              <span className='text-amber-700 font-bold'>8zenSe.com</span>{' '}
              {('Intro_Text01')}{' '}
            </p>{' '}
          </section>{' '}
          <div className='bg-neutral-500 mb-20 flex flex-col'>
            {/*<EmailModal />*/}
          </div>
          <section className='container mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-8 px-8 lg:grid-cols-1'>
            <h1 className='lg:leading-0 via lg:top lg:leading-0 relative -mt-12 bg-slate-600 bg-gradient-to-b from-slate-900 to-slate-500 bg-clip-text px-1 text-[2.0rem] font-black uppercase leading-10 text-transparent md:text-center md:text-[3.750rem]  lg:text-9xl lg:text-[4rem] lg:tracking-wider'>
              {('Intro_Text01')}
            </h1>
